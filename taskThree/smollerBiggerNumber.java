...
public class smollerBiggerNumber {
    void findSmollerBiggerNumber (String [] sourceNumbers) {
        ...
        System.out.println("Самое длинное число  " + longestNumber+"  длинна  " + longestNumber.length());
        System.out.println("Самое короткое число  " + shortNumber+"  длинна  "+ +shortNumber.length());
    }
